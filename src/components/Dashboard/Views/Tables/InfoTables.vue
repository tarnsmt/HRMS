<template>
  <div class="row">
    <div class="col-md-12">
      <p class="category">
        Information of all employees in the company
       </p>
    </div>
  ...
  export default{
    ...
    methods: {
      handleEdit (index, row) {
        ...
        localStorage.setItem('storageName', row.name)
        localStorage.setItem('storageEmail', row.email)
